                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    <div className="relative group">
                        <div className="aspect-[4/5] overflow-hidden rounded-xl">
                            <img alt="Professional chef plating a gourmet dish" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" data-alt="Chef plating a gourmet dish with precision" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDOonrpRq3E8oAWe5Ps2Qam5syoBYmjnQqUDwNBwdz2e7aD7okP7LPy_zcAxmdETAGCwTtXu9WqT4JyBPypI7QFZTMZr7J8LNnUbtStuN5ISFPwZd4KXuErkTjCazyFtYdZ8pl8I7yx7TWB7d8Tj7ggXFQIYZrojmhD5hFwWx5nIVT1rBjw9qs4kC9JIpIBpFGMPbyfOeT3f7rO4sxFbIwStfY7P1Mhc1Geoj71h2DH8X-m2lxZlUBHAuYwl9NAWLuS2c0KFztLSOo" />
                        </div>
                    </div>
                    <div className="space-y-8">
                        ...
                        <div className="space-y-6 text-charcoal/80 leading-relaxed text-lg">
                            ...
                            <div className={`transition-all duration-500 ease-in-out overflow-hidden ${showMoreHistory ? 'max-h-[1000px] opacity-100' : 'max-h-0 opacity-0'}`}>
                                <p className="mt-6">Our kitchen has been the training ground for legendary masters, each contributing a thread to the rich tapestry of our heritage. Today, we continue to blend time-honored techniques with contemporary culinary science.</p>
                                <p className="mt-6">Throughout the decades, we have remained steadfast in our commitment to sustainable sourcing and ethical gastronomy. Every ingredient tells a story of the land it came from, and every dish is a chapter in our ongoing pursuit of perfection.</p>
                            </div>
                        </div>
                        <div className="pt-4">
                            <button onClick={toggleHistory} className="inline-flex items-center gap-2 text-primary font-bold tracking-widest text-xs uppercase group hover:text-primary-hover transition-colors focus:outline-none">
                                <span>{showMoreHistory ? "Read Less" : "Read more history"}</span>
                                <span className={`material-symbols-outlined transition-transform duration-300 ${showMoreHistory ? "rotate-180" : "group-hover:translate-x-1"}`}>trending_flat</span>
                            </button>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="order-2 lg:order-1 space-y-8">
                        ...
                        <div className="grid grid-cols-2 gap-4 pt-4">
                            <div className="aspect-square rounded-lg overflow-hidden">
                                <img alt="Restaurant interior detail" data-alt="Soft lighting in luxury dining room interior" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCePmnnNsYUrYfYnq2GbOJD5Qo4RpUT_b1WqbV8ZEnggcZGZyvXgPZKMgvI-WDxIuYSKIkOyU0eRJBPMP4mGFejevEcgbY0rmcIlXrNVkDbW1_I8J_uWj4ErSIzNjO70ryGAjdhOIh5ke-ngjaMhYm6RutzOeSAnAMyyAXYDsubvrWwZTni2K1lS5Gjiex7QZVabHgsWBxd3yUOOvK_VsTP-rPe_hEO_-xeHZpO6bDM64X8hZvXUSJN0R1M3x7u_WHuFVuEv6rqda0" />
                            </div>
                            <div className="aspect-square rounded-lg overflow-hidden">
                                <img alt="Fine glassware on table" data-alt="Elegant glassware on a white tablecloth" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAlcExWV68Gykj8JEoOG9neSVVso7t9MI6HoeGScKFWT9iHDiz44SDbdZurizpjcJOH6DXSlJlmo33UTGVEV9hoKK5iOjvuReIwcc2e_li4EWZbpoodS4ky_nkVRvleo5ZKVuqJHjx4VIz8we_WZY1x2nCuIBYFy1ez2YGprRIpDqcx_wOd1WU_I118ofgtwJGo-lbklRSYNhfld6JIxnNb5sg-PwyztVPptfAWH__0_wd3k3rL6wQ3MpXwH73qeB78qoBDns6kx2w" />
                            </div>
                        </div>
                    </div>
                    <div className="order-1 lg:order-2">
                        <div className="aspect-video lg:aspect-square overflow-hidden rounded-xl">
                            <img alt="Main dining hall of KUKI" className="w-full h-full object-cover" data-alt="Modern minimalist luxury restaurant dining hall" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBJ2JeheKGODtR5y-C-oJL2KiYJ9M6ax25pOEQmiZW6mF50PR_n59HhhminWT11SCVocUV8micaCt93vWb7tj4R_y5m_lREmfiLV3PnHkFpZMkGIODuOvwBX0eOscNdpKK8WhSpVH48-Xua2Sgb-U1qAVOC6JKZ2d3xlJdFZfopjdzy2v5soeZJEV6R82Fy2oZdFjLYKrh0klHrHBfoLcjp_60ZjVS9FiuVdJGum7eQA1zIRt2U7yvdlJmE6rs4-QQwUniW_nn6xvo" />
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="bg-charcoal text-white py-20 px-6">
                <div className="max-w-7xl mx-auto grid grid-cols-2 lg:grid-cols-4 gap-12 text-center">
                    ...
                    <div className="space-y-2">
                        ...
                        <span className="text-xs font-bold uppercase tracking-widest opacity-60">Master Chefs</span>
                    </div>
                    <div className="space-y-2">
