...
{/* <!-- Close Button --> */}
<button className="text-luxe-text-muted hover:text-luxe-text-dark transition-colors p-2">
...
<div>
<h2 className="text-xl font-semibold text-luxe-text-dark">Marcus Wright</h2>
<p className="text-sm text-luxe-text-muted">m.wright@luxury.co</p>
</div>
</div>
...
<p className="text-xs font-medium text-luxe-text-muted uppercase tracking-wider">OCT 25, 2023</p>
</div>
</section>
...
<p className="text-sm font-semibold text-luxe-text-dark">Oct 24, 2023</p>
</div>
<div data-purpose="meta-item">
...
<button className="w-full sm:w-auto px-8 py-3 rounded-lg border-2 border-luxe-rose text-luxe-rose font-semibold hover:bg-luxe-rose hover:text-white transition-all duration-300 active:scale-95">
          Reject Review
        </button>
<button className="w-full sm:w-auto px-8 py-3 rounded-lg bg-luxe-rose text-white font-semibold hover:bg-[#b07270] shadow-lg shadow-luxe-rose/20 transition-all duration-300 active:scale-95">
          Approve Review
        </button>
</footer>
