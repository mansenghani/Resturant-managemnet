...
<body class="bg-background-light text-luxe-dark min-h-screen">
...
<button class="flex items-center gap-2 bg-primary hover:bg-primary/90 text-white px-6 py-3.5 rounded-2xl font-semibold shadow-lg shadow-primary/30 transition-all duration-300 hover:-translate-y-0.5">
<span class="material-symbols-outlined">add</span>
<span>Add New Dish</span>
</button>
</header>
<!-- Filters -->
<div class="flex flex-wrap items-center gap-2 mb-8 overflow-x-auto pb-2 scrollbar-hide">
<button class="px-6 py-2.5 bg-white text-primary rounded-full shadow-sm border border-primary/20 text-sm font-bold">All Dishes</button>
<button class="px-6 py-2.5 text-luxe-dark/60 hover:bg-white/50 rounded-full text-sm font-medium transition-colors">Appetizers</button>
<button class="px-6 py-2.5 text-luxe-dark/60 hover:bg-white/50 rounded-full text-sm font-medium transition-colors">Main Course</button>
<button class="px-6 py-2.5 text-luxe-dark/60 hover:bg-white/50 rounded-full text-sm font-medium transition-colors">Desserts</button>
<button class="px-6 py-2.5 text-luxe-dark/60 hover:bg-white/50 rounded-full text-sm font-medium transition-colors">Wine List</button>
<button class="px-6 py-2.5 text-luxe-dark/60 hover:bg-white/50 rounded-full text-sm font-medium transition-colors">Chef's Specials</button>
</div>
<!-- Content Card -->
<div class="bg-white rounded-2xl shadow-soft overflow-hidden border border-primary/5">
<div class="overflow-x-auto">
<table class="w-full text-left">
<thead>
<tr class="bg-primary/5 text-luxe-dark/40 uppercase text-[11px] tracking-widest font-bold">
...
<button class="w-9 h-9 rounded-xl bg-[#fcf9f7] text-luxe-dark/60 hover:text-primary hover:bg-primary/10 flex items-center justify-center transition-all border border-primary/5">
...
<div class="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 bg-luxe-dark/60 backdrop-blur-sm">
    <!-- Modal Container -->
    <div class="bg-white w-full max-w-[95%] md:max-w-[90%] lg:max-w-[640px] max-h-[90vh] rounded-2xl shadow-2xl flex flex-col overflow-hidden animate-in fade-in zoom-in duration-300">
        <!-- Modal Header -->
        <div class="px-6 sm:px-8 py-6 border-b border-primary/5 flex items-center justify-between shrink-0">
            ...
            <button onclick="window.location.href='menumanage.php'" class="w-8 h-8 rounded-full flex items-center justify-center text-luxe-dark/40 hover:text-primary hover:bg-primary/5 transition-colors">
                <span class="material-symbols-outlined text-[20px]">close</span>
            </button>
        </div>
        
        <!-- Modal Body -->
        <div class="p-6 sm:p-8 space-y-6 sm:space-y-7 overflow-y-auto">
            <!-- Dish Name -->
            <div class="space-y-2">
                <label class="text-[11px] uppercase tracking-widest text-luxe-dark/40 font-bold ml-1">Dish Name</label>
                <input class="w-full px-4 py-3 rounded-xl border border-primary/10 focus:border-primary focus:ring-1 focus:ring-primary/20 transition-all outline-none text-sm placeholder:text-luxe-dark/20" placeholder="e.g. Pan-seared Scallops" type="text"/>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-6">
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        <select class="w-full px-4 py-3 rounded-xl border border-primary/10 focus:border-primary focus:ring-1 focus:ring-primary/20 transition-all outline-none text-sm appearance-none bg-white">
                ...
                <div class="space-y-2">
                    ...
                    <input class="w-full px-4 py-3 rounded-xl border border-primary/10 focus:border-primary focus:ring-1 focus:ring-primary/20 transition-all outline-none text-sm" placeholder="0.00" type="number"/>
                </div>
            </div>
            ...
            <div class="space-y-2">
                ...
                <textarea class="w-full px-4 py-3 rounded-xl border border-primary/10 focus:border-primary focus:ring-1 focus:ring-primary/20 transition-all outline-none text-sm resize-none placeholder:text-luxe-dark/20 custom-scrollbar" placeholder="Brief description of the dish..." rows="3"></textarea>
            </div>
            
            <!-- Image Upload Placeholder -->
            <div class="space-y-2">
                <label class="text-[11px] uppercase tracking-widest text-luxe-dark/40 font-bold ml-1">Upload Image</label>
                <div class="border-2 border-dashed border-primary/10 rounded-xl p-8 flex flex-col items-center justify-center gap-2 hover:bg-primary/5 transition-colors cursor-pointer group">
                    <span class="material-symbols-outlined text-primary/40 group-hover:text-primary transition-colors text-3xl mb-1">add_a_photo</span>
                    <p class="text-[11px] text-luxe-dark/40 font-medium">Click to upload or drag &amp; drop</p>
                </div>
            </div>
            ...
            <div class="flex flex-row items-center justify-between p-4 bg-primary/[0.03] rounded-xl border border-primary/5">
                ...
                <button class="w-11 h-6 rounded-full bg-primary relative transition-colors shrink-0">
                    <div class="absolute right-1 top-1 w-4 h-4 rounded-full bg-white shadow-sm transition-transform duration-300"></div>
                </button>
            </div>
        </div>
        ...
        <div class="px-6 sm:px-8 py-5 sm:py-6 bg-primary/[0.02] border-t border-primary/5 flex flex-row items-center justify-end gap-3 sm:gap-4 shrink-0">
            <button onclick="window.location.href='menumanage.php'" type="button" class="px-5 sm:px-6 py-2.5 text-sm font-bold text-luxe-dark/40 hover:text-luxe-dark transition-colors shrink-0">Cancel</button>
            <button type="button" class="bg-primary hover:bg-primary/90 text-white px-6 sm:px-8 py-2.5 rounded-xl font-bold shadow-lg shadow-primary/30 transition-all duration-300 hover:-translate-y-0.5 text-sm shrink-0 whitespace-nowrap">
                Save Dish
            </button>
        </div>
    </div>
